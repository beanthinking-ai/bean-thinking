...
if st.button("Find My Coffee Matches"):
    if not flavour_choices or not postcode:
        ...
        if st.button("Submit Feedback"):
            form_url = "https://docs.google.com/forms/d/e/1FAIpQLSdn7-i_8as7gh9-vrZCQyH4LjeTqMxD1D_17GqWD6HI0U_duw/formResponse"
            form_data = {
                "entry.1857227253": nickname,
                "entry.1181871917": st.session_state['session_id'],
                "entry.1069332362": datetime.now().isoformat(),
                "entry.1330742923": ", ".join(flavour_choices),
                "entry.1192898627": style,
                "entry.932212914": adventure,
                "entry.1166145401": postcode,
                "entry.279987682": ", ".join(top_matches),
                "entry.774524835": feedback_rating,
                "entry.1002033833": feedback_comments
            }
            try:
